...
public final class ItemWithDetailsHorizontalBinding implements ViewBinding {
  @NonNull
  ...
  private ItemWithDetailsHorizontalBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ItemWithDetailsHorizontalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemWithDetailsHorizontalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_with_details_horizontal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemWithDetailsHorizontalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemWithDetailsHorizontalBinding((RelativeLayout) rootView, itemDetails, itemImage,
