...
public final class ActivityWatch9CalibrationBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityWatch9CalibrationBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityWatch9CalibrationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityWatch9CalibrationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_watch9_calibration, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityWatch9CalibrationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWatch9CalibrationBinding((RelativeLayout) rootView, npHour, npMinute,
